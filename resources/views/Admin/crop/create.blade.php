...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-6"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / </span>Crops /Add Crop</h4></div>
                        ...
                        <div class="col-12 col-md-8 col-lg-12">
                            <div class="bg-white">
                                <form class="row g-3" action="{{route('crop_create')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="col-md-6">
                                        <input type="text" class="form-control" name="name" placeholder="Crop Name" aria-label="Owner Name">
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <textarea name="climate" class="form-control" placeholder="Climate"></textarea>
                                    </div>
                                    <div class="col-md-6">
                                        <textarea name="soil" class="form-control" placeholder="Soil"></textarea>
                                    </div>
                                    <div class="col-12">
