...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-6"><h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard / </span>Career /Add Career</h4></div>
                            ...
                            <div class="bg-white">
                                <form class="row g-3" method="post" action="{{route('career_save')}}" enctype="multipart/form-data">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="text" class="form-control" name="title" placeholder="Enter Title" aria-label="Coupon Title" value="{{old('title')}}">
                                    </div>
                    
                                    <div class="col-md-6">
                                        <label for="max_amount">Skill</label>
                                        <input type="text" class="form-control" name="skill" placeholder="Enter Skill" value="{{old('skill')}}"
                                            aria-label="">
                                    </div>
                                    <div class="col-md-6">
