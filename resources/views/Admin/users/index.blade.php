...
<div class="content-wrapper">
    <div class="container-xxl flex-grow-1 container-p-y">
        <div class="row">
            <div class="col-6">
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Dashboard /</span>User Master</h4>
            </div>
            @if(Auth::guard('user')->user()->role !== 'user')
            <div class="col-6 text-end"><a href="{{route('users_create')}}"><button type="button" class="btn btn-primary">Add User</button></a></div>
            @endif
        </div>
                ...
                <table class="table table-borderless">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a class="btn btn-sm btn-success" class="edit_category" href="{{route('users_edit',['id'=>$item->id])}}">
