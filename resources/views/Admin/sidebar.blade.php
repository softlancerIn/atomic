...
@php
$company = App\Models\Agent::where('id', Auth::guard('user')->user()->user)->first();
@endphp
    ...
    <div class="app-brand demo">
        ...
        <a href="{{ route('dashboard') }}" class="app-brand-link">
            ...
            <span class="app-brand-logo demo">
                <img src="{{asset('/public/logo.png')}}" style="height:140px;width:165px;">
                {{-- <h5>24x7 Payment Gateway</h5> --}}
            </span>
        </a>
    ...
    <ul class="menu-inner py-1">
        ...
        <li class="menu-item {{$active == 'dashboard' ? 'active': ''}}">
            <a href="{{ route('dashboard') }}" class="menu-link">
                ...
                <div data-i18n="Analytics" class="mx-2">Dashboard</div>
            </a>
        </li>
        ...
        <li class="menu-item {{$active == 'comission' ? 'active': ''}}">
            <a href="{{route('comission')}}" class="menu-link">
                ...
                <div data-i18n="Analytics" class="mx-2">Commission</div>
            </a>
        </li>
        <li class="menu-item {{$active == 'settelment' ? 'active': ''}}">
            <a href="{{route('settelment')}}" class="menu-link">
                ...
                <div data-i18n="Analytics" class="mx-2">Settelment</div>
            </a>
        </li>

        @endif

        @if((Auth::guard('user')->user()->role == 'warehousemanager' || $company) || (Auth::guard('user')->user()->role == 'admin'))
        @if(Auth::guard('user')->user()->role == 'warehousemanager' || $company)
        <li class="menu-item {{$active == 'dashboard' ? 'active': ''}}">
            <a href="{{ route('dashboard') }}" class="menu-link">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-dash-fill" viewBox="0 0 16 16">
                    <path d="M8.707 1.5a1 1 0 0 0-1.414 0L.646 8.146a.5.5 0 0 0 .708.708L8 2.207l6.646 6.647a.5.5 0 0 0 .708-.708L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293z" />
        ...
        <li class="menu-item {{$active == 'bank' ? 'active': ''}}">
            <a href="{{ route('bank_list') }}" class="menu-link">
                ...
                <div data-i18n="Analytics" class="mx-2">Bank</div>
            </a>
        </li>
        ...
        <li class="menu-item {{$active == 'report' ? 'active': ''}}">
            <a href="{{route('report')}}" class="menu-link">
                ...
                <div data-i18n="Analytics" class="mx-2">Report</div>
            </a>
        </li>
